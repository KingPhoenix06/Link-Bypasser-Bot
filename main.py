...
# bot
bot_token = os.environ.get("TOKEN", "5929947495:AAGlrMiE1Lj48hGW-ey_m_jPXI5Huknyeuw")
api_hash = os.environ.get("HASH", "aec1fd7abdfec322c426961a570ef336") 
api_id = os.environ.get("ID", "3369707")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("😎 𝗖ʀᴇᴀᴛᴏʀ", url="https://telegram.dog/Crazy_Phoenix")]]), reply_to_message_id=message.id)
